...
describe("ERC7984ERC20WrapperExample", function () {
  ...
  describe("Wrapping", function () {
    it("should wrap ERC20 tokens", async function () {
      ...
      // Verify confidential balance was created
      // When ERC20 tokens are wrapped, they are locked in the contract
      // and confidential token handles are minted to the recipient
